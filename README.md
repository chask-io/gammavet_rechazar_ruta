...
Registra que un conductor Gammavet rechaza o no puede operar la ruta y cierra o entrega la sesion
...
- The function name matches "RechazarRutaFn"
...
- AWS CloudWatch Logs: `/aws/lambda/RechazarRutaFn`
- Chask dashboard: Organization → Functions → RechazarRutaFn
